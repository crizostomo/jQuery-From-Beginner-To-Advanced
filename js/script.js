...
function validateNameField(name, event) {
  if (!isValidName(name)) {
    $("#name-feedback").text("Please enter at least two caracters");
    event.preventDefault(); 
  } else {
    $("#name-feedback").text("");
  }
...
function validatePasswordField(password, event) {
  if (!isValidPassword(password)) {
    $("#password-feedback").text("The password should have at least six caracters and contain a number");
    event.preventDefault(); 
  } else {
...
function validateCheckBoxField(isChecked, event) {
  if (!isChecked) {
    $("#checkbox-feedback").text("Please, you need to read and agree with this");
    event.preventDefault(); 
  } else {
